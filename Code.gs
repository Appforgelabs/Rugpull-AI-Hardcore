/*************************************************************************
 * Rugpull_AI Hardcore + Corridor — unified Apps Script backend (Code.gs)
 *
 ...
 *
 *   RUGPULL / HARDCORE APP (watchlist + starred)
 ...
 *   3. Use that SAME /exec URL in BOTH the corridor chart and Rugpull AI Hardcore.
 *
...
function doPost(e) {
  ...
  try {
    ...
    // --- Rugpull / Hardcore namespaced app-state ---
